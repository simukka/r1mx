...
**Never use em dashes ("—") in any content produced by agents, including documentation, markdown files, comments, and website pages.** Use `:`, `;`, `,`, or `-` as appropriate to the context instead.
