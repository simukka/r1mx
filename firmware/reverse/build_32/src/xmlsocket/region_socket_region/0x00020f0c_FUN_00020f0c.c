/* 0x00020f0c  FUN_00020f0c  size=244 bytes */


undefined4 FUN_00020f0c(int param_1,int param_2,undefined4 param_3)

{
  ...
  if ((((param_1 < 2 && -1 < (int)((-1 - param_2) + (uint)(param_2 == 0))) && (iRam00e10734 != 0))
    ...
    uVar2 = FUN_00020988(param_1,param_2,0xb0,0xd4,param_3);
