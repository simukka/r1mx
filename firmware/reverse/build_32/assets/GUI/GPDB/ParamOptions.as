class GUI.GPDB.ParamOptions
{
   ...
   function GrabListOfOptionsFromParam()
   {
      ...
      if(this.__optionGeneratorParam)
      {
         ...
         _loc12_ = this.__gpdb.paramGet(this.__optionGeneratorParam);
         if(_loc12_ != "")
         {
   ...
   function SetAndCacheChoices()
   {
      ...
      if(this.__conditionalValues.length > 0)
      {
         ...
         _loc4_ = this.GetConditionalChoices();
   ...
   function SelectNext(step)
   {
      ...
      switch(this.__optionMethod)
      {
         ...
         case "ENUMERATED":
            ...
            {
               _loc2_ += step;
               _loc5_ = this.__focusChoices.length;
   ...
   function SetSelection(value, label)
   {
      ...
      if(label == undefined)
      {
         ...
         {
            _loc4_ = this.DecimalPlaces(this.__focusSeries.increment.toString());
   ...
   function GetBoundedValueList()
   {
      ...
      {
         _loc4_ = this.__gpdb.paramGetNumber(this.__maxValueParam);
   ...
   function GetBoundedSeries()
   {
      ...
      if(this.__maxValueParam)
      {
         _loc2_ = this.__gpdb.paramGetNumber(this.__maxValueParam);
         if(_loc2_ < this.__optionSeries.end)
         {
            _loc5_ = this.__optionSeries.end - _loc2_;
            _loc4_ = Math.floor(_loc5_ / this.__optionSeries.increment);
            _loc3_ = this.__optionSeries.end - _loc4_ * this.__optionSeries.increment;
   ...
   function FormatDecimals(num, digits)
   {
      ...
      {
         _loc5_ = Math.pow(10,digits);
         _loc2_ = String(Math.round(num * _loc5_) / _loc5_);
         if(_loc2_.indexOf(".") == -1)
         {
            _loc2_ += ".0";
         }
         _loc7_ = _loc2_.split(".");
         _loc3_ = digits - _loc7_[1].length;
         _loc1_ = 1;
         while(_loc1_ <= _loc3_)
         {
            _loc2_ += "0";
   ...
   function GetExpandedChoice(value)
   {
      ...
      {
         _loc4_ = this.DecimalPlaces(this.__lastUsedSeries.increment.toString());
