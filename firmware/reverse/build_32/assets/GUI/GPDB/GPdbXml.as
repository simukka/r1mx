class GUI.GPDB.GPdbXml extends XML
{
   ...
   function ParseConditionalValues(node, param)
   {
      ...
      while(_loc4_ != null)
      {
         ...
         _loc3_ = new GUI.GPDB.ConditionalValues(this.__gpdb,_loc14_,_loc12_,_loc6_,param);
         _loc2_ = _loc4_.firstChild;
         while(_loc2_ != null)
         {
            ...
            {
               _loc5_ = _loc2_.attributes.first.substr(0,1) == "+" || _loc2_.attributes.last.substr(0,1) == "+";
   ...
   function parseSync(node)
   {
      ...
      {
         _loc4_ = {target:this,type:_loc3_};
