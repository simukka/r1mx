class GUI.GPDB.GPDB
{
   ...
   function paramRegister(name, type, value)
   {
      ...
      {
         _loc4_ = new GUI.GPDB.GPdbParam(this,name,type,"");
         _loc4_.value = value;
   ...
   function dump()
   {
      ...
      {
         _loc2_ = GUI.GPDB.GPDB.__paramDB[_loc7_].name;
         _loc6_ = GUI.GPDB.GPDB.__paramDB[_loc7_].type;
         _loc3_ = GUI.GPDB.GPDB.__paramDB[_loc7_].value;
         _loc5_ = GUI.GPDB.GPDB.__paramDB[_loc7_].NumberOfCallbacks();
         _loc4_ = _loc5_ <= 0 ? "" : "Registered Callbacks: " + _loc5_;
   ...
   function ShowCallbacks()
   {
      ...
      for(var _loc7_ in GUI.GPDB.GPDB.__paramDB)
      {
         _loc3_ = GUI.GPDB.GPDB.__paramDB[_loc7_].name;
         _loc6_ = GUI.GPDB.GPDB.__paramDB[_loc7_].type;
         _loc4_ = GUI.GPDB.GPDB.__paramDB[_loc7_].value;
         _loc2_ = GUI.GPDB.GPDB.__paramDB[_loc7_].NumberOfCallbacks();
         if(_loc2_ > 0)
         {
            _loc5_ = _loc2_ <= 0 ? "" : " Callbacks: " + _loc2_;
         }
