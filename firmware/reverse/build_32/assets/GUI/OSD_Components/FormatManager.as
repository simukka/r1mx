class GUI.OSD_Components.FormatManager
{
   ...
   function SmartFormat()
   {
      ...
      if(this.__diskBeingFormatted == "NONE")
      {
         ...
         {
            _loc3_ = this.__diskBeingFormatted != "DRIVE0" ? "EXTERNAL" : "INTERNAL";
            _loc4_ = this.__gpdb.paramGet("MEDIA.DIGMAG." + this.__diskBeingFormatted + ".GUI_STATE");
            switch(_loc4_)
            {
               case "NOTPRESENT":
   ...
   function BootSmartFormat()
   {
      ...
      if(_loc2_ != "NONE")
      {
         _loc3_ = this.__gpdb.paramGet("MEDIA.DIGMAG." + _loc2_ + ".GUI_STATE");
         switch(_loc3_)
         {
            case "NOTPRESENT":
            case "EXPORTED":
   ...
   function DoFormatDone(param, value)
   {
      ...
      if(value == "true")
      {
         _loc2_ = this.__gpdb.paramGetNumber("CAMERA.FORMAT_COMPLETE_MESSAGE");
         if(_loc2_ == 1)
         {
   ...
   function DoDiskYanked(name, value)
   {
      ...
      if(this.__diskBeingFormatted != "NONE")
      {
         _loc3_ = "MEDIA.DIGMAG." + this.__diskBeingFormatted + ".GUI_STATE";
