class GUI.OSD_Components.SystemDateMC extends MovieClip
{
   ...
   function NewButton(tabInfo, label, x, y, action)
   {
      ...
      {
         _loc5_ = "button_" + label;
         _loc4_ = this.attachMovie("PanelButtonMC",_loc5_,this.getNextHighestDepth(),{_x:x,_y:y,__label:label,_onRelease:mx.utils.Delegate.create(this,action)});
