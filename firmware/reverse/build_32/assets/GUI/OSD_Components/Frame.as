class GUI.OSD_Components.Frame extends MovieClip
{
   ...
   function Render()
   {
      ...
      {
         _loc3_ = this.__gpdb.paramGet("GUI.OSD.RETICLE.TV_SAFE_AREA.CENTER_CURSOR.STYLE");
