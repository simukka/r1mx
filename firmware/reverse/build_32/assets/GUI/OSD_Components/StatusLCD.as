class GUI.OSD_Components.StatusLCD extends MovieClip
{
      ...
      else
      {
         ...
         switch(_loc3_)
         {
            ...
            case "MOUNTED":
               ...
               {
                  _loc4_ = this.__gpdb.paramGet("MEDIA.DIGMAG.CURRENT_CLIPNAME").substr(0,9);
   ...
   function HandleMediaRemaining()
   {
      ...
      else
      {
         ...
         {
            _loc4_ = Math.floor(Number(this.__gpdb.paramGet("MEDIA.DIGMAG.CAPACITY.TIME_REMAINING")) / 60);
