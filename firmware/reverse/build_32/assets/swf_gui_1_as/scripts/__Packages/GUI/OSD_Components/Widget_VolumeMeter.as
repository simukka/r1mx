class GUI.OSD_Components.Widget_VolumeMeter extends GUI.OSD_Components.Gadget
{
   ...
   function LableAudioGainButtons()
   {
      ...
      while(_loc3_ <= 4)
      {
         var _loc2_ = _loc3_.toString();
         var _loc4_ = "LINE" != this.__gpdb.paramGet("AUDIO.INPUT.CHANNEL_" + _loc2_ + ".SOURCE") ? "CH " + _loc2_ + " (MIC)" : "CH " + _loc2_ + " (LINE)";
         ...
         var _loc5_ = "LINE" != this.__gpdb.paramGet("AUDIO.INPUT.CHANNEL_" + _loc2_ + ".SOURCE") ? 0 : 1;
   ...
   function HandlePhantomPower()
   {
      ...
      while(_loc2_ <= 4)
      {
         ...
         var _loc4_ = "AUDIO.INPUT.CHANNEL_" + _loc3_ + ".PHANTOM48V_ENABLE";
   ...
   function ChannelText(ch)
   {
      ...
      if(this.__gpdb.paramGetBoolean("AUDIO.INPUT.CHANNEL_" + _loc3_ + ".ENABLE"))
      {
         var _loc4_ = this.__gpdb.paramGet("AUDIO.INPUT.CHANNEL_" + _loc3_ + ".SOURCE");
         var _loc5_ = this.__gpdb.paramGetBoolean("AUDIO.INPUT.CHANNEL_" + _loc3_ + ".PHANTOM48V_ENABLE");
         if(_loc5_)
         {
            _loc2_ = "48V";
         }
