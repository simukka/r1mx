class GUI.OSD_Components.PanelNotFlagMC extends GUI.OSD_Components.PanelWidget
{
   var __gpdb;
   var __mc;
   var label;
   ...
   function update()
   {
      if(this.__checked)
      {
         this.__mc.gotoAndPlay("IS_TRUE");
      }
      else
      {
         this.__mc.gotoAndPlay("IS_FALSE");
      }
   }
   function SetManagedParameter(paramName)
   {
      ...
      throw new Error("PanelNotFlagMC::SetManagedParameter() ERROR. Unregistered parameter: \'" + paramName + "\'");
   }
