class GUI.OSD_Components.FullScreenMC extends GUI.OSD_Components.Gadget
{
   ...
   function NewButton(label, action, x, y, cbArg)
   {
      ...
      else
      {
         x = x !== undefined ? x : 0;
         y = y !== undefined ? y : 0;
         var _loc8_ = this.NewID(label);
         var _loc4_ = this.attachMovie("PanelButtonMC",_loc8_,this.getNextHighestDepth(),{__label:label,_onRelease:mx.utils.Delegate.create(this,action),__cbArgRelease:cbArg,_x:x,_y:y});
