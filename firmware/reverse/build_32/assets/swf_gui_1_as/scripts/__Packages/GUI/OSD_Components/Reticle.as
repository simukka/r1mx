class GUI.OSD_Components.Reticle extends MovieClip
{
   ...
   function DrawNamedReticle(aspect)
   {
      ...
      switch(this.__resolution)
      {
         ...
         case "4K40":
            switch(aspect)
            {
               case "RECORD_AREA":
                  this.__fguideWidth = 1800;
                  this.__fguideHeight = 780;
                  break;
               case "4:3":
                  this.__fguideWidth = 1040;
                  this.__fguideHeight = 780;
                  break;
               case "16:9":
                  this.__fguideWidth = 1386;
                  this.__fguideHeight = 780;
                  break;
               case "1.85":
                  this.__fguideWidth = 1443;
                  this.__fguideHeight = 780;
                  break;
               case "2.35":
                  this.__fguideWidth = 1800;
         ...
         case "4KOS":
            ...
            {
               case "RECORD_AREA":
                  this.__fguideWidth = 2040;
                  this.__fguideHeight = 1020;
                  break;
               case "4:3":
                  this.__fguideWidth = 1360;
                  this.__fguideHeight = 1020;
                  break;
               case "16:9":
                  this.__fguideWidth = 1814;
                  this.__fguideHeight = 1020;
                  break;
               case "1.85":
                  this.__fguideWidth = 1888;
                  this.__fguideHeight = 1020;
                  break;
               case "2.35":
                  this.__fguideWidth = 2010;
                  this.__fguideHeight = this.__fguideWidth / 2.35;
                  break;
               case "2.39":
                  this.__fguideWidth = 2010;
      ...
      if(this.__resolution == "4KOS")
      {
         _loc5_ = (2040 - this.__fguideWidth) / 2;
         _loc4_ = (1020 - this.__fguideHeight) / 2;
      }
      if(this.__resolution == "4K40")
      {
         _loc5_ = (1800 - this.__fguideWidth) / 2;
         _loc4_ = (780 - this.__fguideHeight) / 2;
      }
