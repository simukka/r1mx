class GUI.OSD_Components.Graphics extends MovieClip
{
   ...
   function drawCircle(r, x, y)
   {
      ...
      while(_loc2_ <= 360)
      {
         var _loc5_ = r * Math.cos(_loc2_ * 3.141592653589793 / 180);
         var _loc4_ = r * Math.sin(_loc2_ * 3.141592653589793 / 180);
         var _loc7_ = _loc5_ + r * _loc8_ * Math.cos((_loc2_ - 90) * 3.141592653589793 / 180);
         var _loc6_ = _loc4_ + r * _loc8_ * Math.sin((_loc2_ - 90) * 3.141592653589793 / 180);
