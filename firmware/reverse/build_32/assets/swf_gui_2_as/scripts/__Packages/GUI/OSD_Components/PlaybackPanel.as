class GUI.OSD_Components.PlaybackPanel extends GUI.OSD_Components.Gadget
{
   ...
   function SetClips(clips)
   {
      ...
      {
         var _loc2_ = this.__clips[_loc3_];
      ...
      switch(state)
      {
         ...
         case this.PLAYBACK_STATE_FF_32X:
            ...
            if(!this.__clip)
            {
               ...
               var _loc2_ = parseInt(this.__gpdb.paramGet("VIDEO.PLAYBACK.CURRENTFRAME"));
               if(isNaN(_loc2_))
               {
                  _loc2_ = 0;
               }
      ...
      if(!_loc5_ && _loc6_)
      {
         switch(param)
         {
            ...
            case "GUI.RAWINPUT.BUTTON.PLAYBACK.RR":
               var _loc3_ = this.GetNextRRSpeed();
               if(_loc3_ > 0)
               {
   ...
   function PositionPlayhead()
   {
      if(this.__clip)
      {
         var _loc2_ = this.__clip.GetProgress() * this.PROGRESS_BAR_WIDTH;
   ...
   function UpdateProgress()
   {
      ...
      {
         var _loc2_ = getTimer();
         var _loc3_ = _loc2_ - this.__t;
         this.__t = _loc2_;
         if(this.__timeFactor != 0)
         {
            var _loc4_ = this.__clip.timecode.AdvanceMS(_loc3_,this.__timeFactor);
            this.__t -= _loc4_;
            this.PositionPlayhead();
         }
      }
