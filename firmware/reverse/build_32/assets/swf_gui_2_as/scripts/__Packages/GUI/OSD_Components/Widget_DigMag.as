class GUI.OSD_Components.Widget_DigMag extends MovieClip
{
   ...
   function HandleInsertionState(targettedDrive)
   {
      ...
      {
         var _loc3_ = this.__gpdb.paramGetBoolean("MEDIA.DIGMAG.DRIVE0.FORMAT_REQUEST") || this.__gpdb.paramGetBoolean("MEDIA.DIGMAG.DRIVE1.FORMAT_REQUEST");
         if(!_loc3_)
         {
   ...
   function UpdateDigmagVisual()
   {
      ...
      switch(_loc6_)
      {
         ...
         case "DigMag":
            ...
            {
               var _loc5_ = this.__gpdb.paramGetNumber("CAMERA.SLAVE_MODE_ACTIVE");
               var _loc9_ = this.__gpdb.paramGetBoolean("MEDIA.DIGMAG.DRIVE0.FORMAT_REQUEST");
               var _loc8_ = this.__gpdb.paramGetBoolean("MEDIA.DIGMAG.DRIVE1.FORMAT_REQUEST");
               if(_loc5_ == 2 && _loc9_)
               {
            ...
            {
               var _loc4_ = this.__mediaMgr.GetTargettedDrive();
               var _loc7_ = this.__gpdb.paramGet("MEDIA.DIGMAG." + _loc4_ + ".GUI_STATE");
   ...
   function Update(name, value)
   {
      switch(name)
      {
         case "GUI.RUN_STATE":
            ...
            {
               var _loc4_ = this.__gpdb.paramGet("MEDIA.DIGMAG.ACTIVEDRIVE");
               if(_loc4_ != "NONE")
               {
                  var _loc5_ = "MEDIA.DIGMAG." + _loc4_ + ".GUI_STATE";
                  var _loc6_ = this.__gpdb.paramGet(_loc5_);
