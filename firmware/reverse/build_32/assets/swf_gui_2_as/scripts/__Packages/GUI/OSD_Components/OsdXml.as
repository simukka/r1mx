class GUI.OSD_Components.OsdXml extends XML
{
   ...
   function MyOnLoad(success)
   {
      if(success)
      {
         ...
         var _loc3_ = {target:this,type:"xmlPanelLoadComplete"};
   ...
   function NewMenuPanel(aNode, forcedID)
   {
      ...
      if(aNode)
      {
         var _loc3_ = aNode.attributes.type;
         if(_loc3_ == undefined)
         {
            _loc3_ = "button";
         }
         ...
         var _loc4_ = aNode.attributes.id;
         ...
         var _loc7_ = aNode.attributes.label;
         if(_loc7_ != undefined)
         {
   ...
   function NewButton(node, panel)
   {
      ...
      if(_loc13_ == 0 && (_loc5_ != "STint" && _loc5_ != "SWBAL" && _loc5_ != "SFlut"))
      {
         ...
         {
            var _loc14_ = _global.VxCapability(_loc11_);
            if(!_loc14_)
            {
         ...
         while(_loc4_ != null)
         {
            ...
            switch(_loc3_.cbAction)
            {
               ...
               case "Parameter":
                  ...
                  var _loc6_ = _global.gpdb.getParam(_loc3_.cbData);
                  if(_loc6_ == null)
                  {
      ...
      while(_loc3_ != null)
      {
         ...
         switch(_loc4_.cbAction)
         {
            ...
            case "Parameter":
               ...
               var _loc6_ = _loc3_.attributes.name;
               var _loc7_ = _global.gpdb.getParam(_loc6_);
               if(_loc7_ == null)
               {
   ...
   function NewSelectorTab(node, parentId, parentPanel)
   {
      ...
      {
         var _loc11_ = "SELECT_TAB_" + parentId;
         var _loc9_ = parentPanel.getMovieClip();
         ...
         var _loc13_ = node.attributes.prefix;
         if(_loc13_)
         {
            _loc7_.setPrefix(_loc13_);
         }
         var _loc14_ = node.attributes.suffix;
         if(_loc14_)
         {
            _loc7_.setSuffix(_loc14_);
         }
         var _loc12_ = "true" == node.attributes.continuousUpdate;
         if(_loc12_)
         {
